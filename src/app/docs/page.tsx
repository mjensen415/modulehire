      ...
      <div className="docs-layout">
        <aside className="docs-sidebar">
          <div className="sidebar-section">
            ...
            <Link href="/docs" className="sidebar-link active">Quick start</Link>
            <Link href="#" className="sidebar-link">Upload your first resume</Link>
            <Link href="#" className="sidebar-link">Understanding modules</Link>
          </div>
          <div className="sidebar-divider"></div>
          <div className="sidebar-section">
            <div className="sidebar-section-title">The Module System</div>
            <Link href="#" className="sidebar-link">Module types</Link>
            <Link href="#" className="sidebar-link">Tags and themes</Link>
            <Link href="#" className="sidebar-link">Editing modules</Link>
          </div>
          <div className="sidebar-divider"></div>
          <div className="sidebar-section">
            <div className="sidebar-section-title">Generating Resumes</div>
            <Link href="#" className="sidebar-link">Job description input</Link>
            <Link href="#" className="sidebar-link">Module matching</Link>
            <Link href="#" className="sidebar-link">Output formats</Link>
          </div>
          <div className="sidebar-divider"></div>
          <div className="sidebar-section">
            <div className="sidebar-section-title">
              API <span style={{ fontFamily: 'var(--mono)', fontSize: 9, background: 'var(--surface2)', border: '1px solid var(--border2)', borderRadius: 3, padding: '1px 5px', marginLeft: 4, color: 'var(--text3)' }}>Soon</span>
            </div>
            <Link href="#" className="sidebar-link dim">Authentication <span className="coming-soon">Soon</span></Link>
            <Link href="#" className="sidebar-link dim">Endpoints <span className="coming-soon">Soon</span></Link>
            <Link href="#" className="sidebar-link dim">Webhooks <span className="coming-soon">Soon</span></Link>
          </div>
        </aside>
        ...
        <main className="docs-content">
          ...
          <div className="step-block">
            ...
            <div className="step-block-body">
              ...
              <p>Go to <span className="inline-code">app-upload</span> and drag your resume into the upload zone, or click <strong>Browse files</strong>. Supported formats: PDF, DOCX, TXT, RTF. Max file size is 10MB. Processing takes 5–15 seconds depending on resume length.</p>
            </div>
          </div>
          ...
          <div className="callout">
            ...
            <div className="callout-text"><strong>Tip:</strong> Upload your most comprehensive resume first — the one that covers the most ground. Additional uploads will add to your library, not replace it.</div>
          </div>
          ...
          <div className="step-block">
            ...
            <div className="step-block-body">
              ...
              <p>The module selection screen shows your library ranked by match score. Toggle modules in or out of the stack. Choose a positioning variant (Community-First, Builder, etc.) that fits the role. Lock any anchor modules you always want included.</p>
            </div>
          </div>
          ...
          <div className="callout amber">
            ...
            <div className="callout-text"><strong>Free plan note:</strong> Generated resume download links expire after 24 hours. If you need permanent storage, upgrade to Pro.</div>
          </div>
          ...
          <div className="docs-nav-footer">
            <Link href="#" className="docs-nav-btn">
